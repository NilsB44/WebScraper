...
from src.models import CandidateItem, ScrapeTask, SearchPageSource
...
class TestScenarios(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_no_candidates_scenario(self) -> None:
    ...
    async def test_fuzzy_search_scenarios(self) -> None:
    ...
    async def test_skip_seen_urls(self) -> None:
